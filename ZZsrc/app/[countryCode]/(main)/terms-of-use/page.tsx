...
export default function TermsOfUsePage() {
  return (
    <Layout className="pt-47 pb-32">
      ...
      >
        <h1 className="text-2xl mb-25">Terms of Use for Younithy</h1>
      </LayoutColumn>
      <LayoutColumn
        start={{ base: 1, lg: 2, xl: 3 }}
      ...
      >
        <p>
          Welcome to Younithy. These Terms of Use govern your access to and
        ...
        <p>
          ...
          logos, images, videos, and trademarks, are the property of Younithy
        ...
        <p>
          To the maximum extent permitted by law, Younithy and its
        ...
        <p>
          You agree to indemnify, defend, and hold harmless Younithy and its
